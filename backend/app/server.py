    ...
    async def loop(self) -> None:
        while True:
            ...
            if (
                ...
                self._take_snapshot()
                self.engine.snapshot_stats["periodic"] += 1
    ...
    return JSONResponse(
        {
            ...
            # landed -- see engine._event_snapshot). Operator-triggered snapshots
            # (God Mode, admin) are not cadence and are not counted here.
